...
- (void)awakeFromNib
{
    ...
    [self.sureBtn setTitleColor:[UIColor xt_lightGreenColor] forState:0];
    self.sureBtn.layer.borderColor = [[UIColor xt_lightGreenColor] CGColor];
    self.sureBtn.layer.masksToBounds = YES;
    
    /** 取消按钮 */
    self.cannelBtn.layer.cornerRadius = 4;
    self.cannelBtn.layer.borderWidth = 1;
    self.cannelBtn.layer.borderColor = [[UIColor xt_lightBlueColor] CGColor];
